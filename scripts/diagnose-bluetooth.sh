...
echo "  - 'hci_uart_bcm serial0-0: Unexpected ACPI gpio_int_idx: -1'"
echo "  - 'hci_uart_bcm serial0-0: Unexpected number of ACPI GPIOs: 0'"
echo "  - 'hci_uart_bcm serial0-0: No reset resource, using default baud rate'"
echo "  - 'BCM4350C0 UART 37.4 MHz Gamay USI UHE' / 'BCM (003.001.134) build 1532'"
echo "Genuinely bad: 'command 0xfc18 tx timeout' / 'BCM: Reset failed (-110)'"
echo "  (bluetoothctl list may be empty; a Linux reboot usually recovers it)"
